function alinharLocais(n){alinharLocal(n,"cerimonia");alinharLocal(n,"recepcao")}function alinharLocal(n,t){if(n>767){var r=$("#foto-cerimonia").height(),i=r/3.25;$("#local-"+t).css("padding-top",i+"px");$("#hora-"+t).css("padding-top",i+"px");$("#foto-"+t).css("padding-top","");$("#foto-"+t).css("padding-bottom","")}else $("#local-"+t).css("padding-top",""),$("#hora-"+t).css("padding-top",""),$("#foto-"+t).css("padding-top","30px"),$("#foto-"+t).css("padding-bottom","30px")}function configurarSubmissaoDeRsvp(){$("#group_591776550_1").click(function(){var n=$("#entry_1004913611");n.show();n.attr("required","")});$("#group_591776550_2").click(function(){var n=$("#entry_1004913611");n.hide();n.removeAttr("required")});$("#ss-form").submit(function(n){$("#confirmacao-envio-rsvp").html("");var t=$(this).serializeArray(),i=$(this).attr("action");$.ajax({url:i,type:"POST",dataType:"jsonp",crossDomain:!0,data:t,beforeSend:function(){mostrarProgressBar()},complete:function(n){var t,i;switch(n.status){case 200:t='<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">×<\/button><strong>Obrigado!<\/strong><br/>Sua confirmação foi enviada com sucesso.<\/div>';$("#confirmacao-envio-rsvp").html(t);resetForm($("#ss-form"));break;default:i='<div class="alert alert-error"><button type="button" class="close" data-dismiss="alert">×<\/button><strong>Algo deu errado...<\/strong><br/>Tente enviar sua confirmação novamente.<\/div>';$("#confirmacao-envio-rsvp").html(i)}ocultarProgressBar()}});n.preventDefault()})}function mostrarProgressBar(){$(".loading").length==0&&($("body").append('<div class="loading"><div class="progress progress-striped active" style="height: 10px;"><div class="bar"><\/div><\/div><\/div>'),$(".loading").slideDown(),$(".loading .progress .bar").delay(300).css("width","100%"))}function ocultarProgressBar(){$(".loading").delay(1e3).slideUp(500,function(){$(this).remove()})}function mostrarVideoInicial(n){var r=$("body").hasClass("oldie"),i,t;n<=400?$("#page-welcome").css("background","url(assets/images/pages/home/bg0.jpg) 55% 0 no-repeat fixed"):n<=700?$("#page-welcome").css("background","url(assets/images/pages/home/bg.jpg) 55% 0 no-repeat fixed"):n<=1080||r?$("#page-welcome").css("background","url(assets/images/pages/home/bg1.jpg) 45% 0 no-repeat fixed"):(i=$("#page-welcome"),i.append('<div class="video-overlay"><\/div>'),t=Math.floor(Math.random()*2+1),i.videoBG({mp4:"assets/videos/pages/home/outgrayslow"+t+".mp4",webm:"assets/videos/pages/home/outgrayslow"+t+".webm",poster:"assets/videos/pages/home/outgray"+t+".jpg",scale:!0,zIndex:0,autoplay:!0,loop:!0}))}function exibirGaleria(){adicionarFotosDosNoivos();adicionarFotosDoCha();$("#container-fotos").children().shuffle();$("#container-fotos").mixitup({targetSelector:".pics",filterSelector:".gallery-filter",sortSelector:".sort",buttonEvent:"click",effects:["fade","rotateY"],listEffects:null,easing:"smooth",layoutMode:"grid",targetDisplayGrid:"inline-block",targetDisplayList:"block",gridClass:"",listClass:"",transitionSpeed:600,showOnLoad:"all",sortOnLoad:!1,multiFilter:!1,filterLogic:"or",resizeContainer:!0,minHeight:0,failClass:"fail",perspectiveDistance:"3000",perspectiveOrigin:"50% 50%",animateGridList:!0,onMixLoad:null,onMixStart:null,onMixEnd:configurarGaleria("container-fotos")})}function adicionarFotosDosNoivos(){adicionarFotos(34,"noivos")}function adicionarFotosDoCha(){adicionarFotos(45,"cha")}function adicionarFotos(n,t){for(var f,u,r=[],i=1;i<=n;i++)r.push(i);for(r=shuffle(r),f=$("#container-fotos"),i=0;i<n;i++)u=r[i],f.append('<a href="pages/galeria/img/'+t+"/"+u+'.JPG" class="pics todas '+t+'"><img class="lazy" data-original="pages/galeria/img/'+t+"/thumbnails/"+u+'.JPG" alt=""><\/a>')}function configurarConteudoDaTimeLine(){configurarGaleria("fotos-taiba");configurarGaleria("fotos-blumenau");configurarGaleria("fotos-oktoberfest");configurarGaleria("fotos-lolla");configurarVideo("video-dois-anos","http://player.vimeo.com/video/107434031?portrait=0");configurarVideo("video-pedido","http://player.vimeo.com/video/103098896?portrait=0")}function configurarGaleria(n){document.getElementById(n).onclick=function(t){t=t||window.event;var i=t.target||t.srcElement,r=i.src?i.parentNode:i,u={index:r,event:t},f=$("#"+n).children().filter(":visible");blueimp.Gallery(f,u)}}function configurarVideo(n,t){$("#"+n).html('<iframe src="'+t+'" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen><\/iframe>')}function definirBackgroundsDasSecoes(n){n<=700?($("#cerimonia").css("background","url(assets/images/pages/cerimonia/bgmobmin.jpg) 50% 20% no-repeat fixed"),$("#rsvp").css("background","url(assets/images/pages/rsvp/bgmob.jpg) 20% 20% no-repeat fixed"),$("#mensagens").css("background","url(assets/images/pages/mensagens/bgmobmin.jpg) 50% 0 no-repeat fixed"),$("#prerodape").css("background","url(assets/images/pages/prerodape/bgmob.jpg) 50% 0 no-repeat fixed")):n<=1080?($("#cerimonia").css("background","url(assets/images/pages/cerimonia/bgmob.jpg) 70% -30% no-repeat fixed"),$("#rsvp").css("background","url(assets/images/pages/rsvp/bgmob.jpg) 20% 20% no-repeat fixed"),$("#mensagens").css("background","url(assets/images/pages/mensagens/bgmob.jpg) 50% no-repeat fixed"),$("#prerodape").css("background","url(assets/images/pages/prerodape/bgmob.jpg) 50% 0 no-repeat fixed")):n<=1601?($("#cerimonia").css("background","url(assets/images/pages/cerimonia/bg.jpg) 50% 20% no-repeat fixed"),$("#rsvp").css("background","url(assets/images/pages/rsvp/bg.jpg) 30% 0 no-repeat fixed"),$("#mensagens").css("background","url(assets/images/pages/mensagens/bg.jpg) 50% 0 no-repeat fixed"),$("#prerodape").css("background","url(assets/images/pages/prerodape/bg.jpg) 50% 0 no-repeat fixed")):($("#cerimonia").css("background","url(assets/images/pages/cerimonia/bgbig.jpg) 50% 20% no-repeat fixed"),$("#rsvp").css("background","url(assets/images/pages/rsvp/bgbig.jpg) 30% 0 no-repeat fixed"),$("#mensagens").css("background","url(assets/images/pages/mensagens/bgbig.jpg) 50% 0 no-repeat fixed"),$("#prerodape").css("background","url(assets/images/pages/prerodape/bgbig.jpg) 50% 0 no-repeat fixed"))}function configurarMapaDaCerimonia(){mapaCerimonia=new GMaps({div:"#mapa-cerimonia",lat:-3.7308473,lng:-38.5171216});google.maps.event.addListener(mapaCerimonia.map,"click",function(){this.setOptions({scrollwheel:!0});zoomAtivado=!0});var n={lat:-3.7308473,lng:-38.5171216,title:"Paróquia Cristo Rei"};mapaCerimonia.addMarker(n);$("#formulario-cerimonia").submit(function(t){t.preventDefault();GMaps.geocode({address:$("#texto-cerimonia").val().trim(),callback:function(t,i){if(i==="OK"){var r=t[0].geometry.location;mapaCerimonia.setCenter(r.lat(),r.lng());mapaCerimonia.removeMarkers();marcadorCerimonia={lat:r.lat(),lng:r.lng(),title:"Seu endereço"};mapaCerimonia.addMarker(n);mapaCerimonia.addMarker(marcadorCerimonia);mapaCerimonia.removeRoutes();mapaCerimonia.removePolylines();rotaCerimonia={origin:[marcadorCerimonia.lat,marcadorCerimonia.lng],destination:[n.lat,n.lng],travelMode:"driving",strokeColor:"#4e808e",strokeOpacity:.6,strokeWeight:6};mapaCerimonia.drawRoute(rotaCerimonia)}}})})}function configurarMapaDaRecepcao(){mapaRecepcao=new GMaps({div:"#mapa-recepcao",lat:-3.7928264,lng:-38.4811093});google.maps.event.addListener(mapaRecepcao.map,"click",function(){this.setOptions({scrollwheel:!0});zoomAtivado=!0});var n={lat:-3.7928264,lng:-38.4811093,title:"Viriato Buffet"};mapaRecepcao.addMarker(n);$("#formulario-recepcao").submit(function(t){t.preventDefault();GMaps.geocode({address:$("#texto-recepcao").val().trim(),callback:function(t,i){if(i==="OK"){var r=t[0].geometry.location;mapaRecepcao.setCenter(r.lat(),r.lng());mapaRecepcao.removeMarkers();marcadorRecepcao={lat:r.lat(),lng:r.lng(),title:"Seu endereço"};mapaRecepcao.addMarker(n);mapaRecepcao.addMarker(marcadorRecepcao);mapaRecepcao.removeRoutes();mapaRecepcao.removePolylines();rotaRecepcao={origin:[marcadorRecepcao.lat,marcadorRecepcao.lng],destination:[n.lat,n.lng],travelMode:"driving",strokeColor:"#4e808e",strokeOpacity:.6,strokeWeight:6};mapaRecepcao.drawRoute(rotaRecepcao)}}})})}function OnScrollPagina(){zoomAtivado&&(mapaCerimonia.map.setOptions({scrollwheel:!1}),mapaRecepcao.map.setOptions({scrollwheel:!1}),zoomAtivado=!1)}function exibirMensagens(){var t,n;if(!(mensagens.length<1)&&(t=$("#container-mensagens"),shuffle(mensagens),adicionarMensagemAo(t,0,"active item"),mensagens.length!==1)){for(n=1;n<mensagens.length;n++)adicionarMensagemAo(t,n,"item");configurarSliderDeMensagens();configurarProgressBar()}}function adicionarMensagemAo(n,t,i){n.append('<div class="'+i+'">'+mensagens[t].texto+"<h5>"+mensagens[t].autor+"<\/h5><\/div>")}function configurarSliderDeMensagens(){$("#msg-slider").each(function(){$(".item",this).length&&$(this).carousel({interval:6e5})});indexMensagemAtual=1;totalMensagens=mensagens.length}function configurarProgressBar(){var n=document.getElementById("progresso-mensagens");linhaProgressoMensagens=new ProgressBar.Line(n,{color:"#4e808e",trailColor:"#fff",strokeWidth:2});linhaProgressoMensagens.animate(indexMensagemAtual/totalMensagens)}function recuarProgressoMensagens(){indexMensagemAtual=indexMensagemAtual-1;indexMensagemAtual===0&&(indexMensagemAtual=totalMensagens);linhaProgressoMensagens.animate(indexMensagemAtual/totalMensagens)}function avancarProgressoMensagens(){indexMensagemAtual=indexMensagemAtual+1;indexMensagemAtual>totalMensagens&&(indexMensagemAtual=1);linhaProgressoMensagens.animate(indexMensagemAtual/totalMensagens)}function configurarSubmissaoDeMensagem(){$("#ss-form2").submit(function(n){$("#confirmacao-envio-mensagem").html("");var t=$(this).serializeArray(),i=$(this).attr("action");$.ajax({url:i,type:"POST",dataType:"jsonp",crossDomain:!0,data:t,beforeSend:function(){mostrarProgressBar()},complete:function(n){var t,i;switch(n.status){case 200:t='<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">×<\/button><strong>Obrigado!<\/strong><br/>Sua mensagem foi enviada com sucesso e será exibida em breve.<\/div>';$("#confirmacao-envio-mensagem").html(t);resetForm($("#ss-form2"));break;default:i='<div class="alert alert-error"><button type="button" class="close" data-dismiss="alert">×<\/button><strong>Algo deu errado...<\/strong><br/>Tente enviar sua mensagem novamente.<\/div>';$("#confirmacao-envio-mensagem").html(i)}ocultarProgressBar()}});n.preventDefault()})}function cargaInicialDePresentes(){$("#casasfreitas").popover({template:'<div class="popover" role="tooltip"><div class="arrow"><\/div><h3 class="popover-title"><\/h3><div class="popover-content">Av. Dom Luís, 281 <br/> <a href="http://www.casafreitas.com.br/site/lojas" target="_blank">Ver todos<\/a><\/div><\/div>'});$("#paypal").popover({template:'<div class="popover" role="tooltip"><div class="arrow"><\/div><h3 class="popover-title"><\/h3><div class="popover-content">PayPal é um sistema que permite a transferência de dinheiro entre indivíduos ou negociantes usando um endereço de e-mail, evitando métodos tradicionais como cheques e boleto bancário.<br/> <a href="https://www.paypal.com/br/webapps/mpp/pay-online" target="_blank">Saber mais<\/a><\/div><\/div>'});configurarCategorias()}function carregarMaisPresentes(){containerMaisPresentes.hide();spinner.show();categoriaAtual=obterCategoriaAtual();var t=obterQuantidadeExibida(),n=Math.ceil(t/3)*3-t;n===0&&(n=3);requisitarPresentes(containerMaisPresentes,"",0,n)}function configurarCategorias(){configurarCategoria(categoriaCmb);configurarCategoria(categoriaEletro);configurarCategoria(categoriaUtils)}function configurarCategoria(n){n.itensRestantes=[];for(var t=1;t<=n.quantidade;t++)n.itensRestantes.push(t);shuffle(n.itensRestantes)}function obterQuantidadeExibida(){return $("#lista-presentes").children(":visible").length}function obterCategoriaAtual(){var n=$("a.active").data("filter");return obterCategoriaPor(n)}function requisitarPresentes(n,t,i,r){var u;try{u=categoriaAtual===null?obterPresente():obterPresenteDaCategoria(categoriaAtual)}catch(f){exibirPresentes(n,t);return}$.ajax({url:u.url,dataType:"html",success:function(f){i+=1;t=t+f;u.categoria.itensRestantes.shift();i<r?requisitarPresentes(n,t,i,r):exibirPresentes(n,t)},error:function(){requisitarPresentes(n,t,i,r)}})}function exibirPresentes(n,t){spinner.hide();$(t).appendTo("."+n.data("destination"));setTimeout(function(){configurarVisibilidadeBotao(categoriaAtual===null?"todos":categoriaAtual.nome)},700);$("img.lazy").lazyload({effect:"fadeIn",threshold:300})}function obterPresente(){var n=obterCategoria();return obterPresenteDaCategoria(n)}function obterPresenteDaCategoria(n){if(n.itensRestantes.length<=0)throw"Não há mais presentes";var i=n.nome,t=n.itensRestantes[0];return{url:"pages/presentes/"+i+"/item"+t+".min.html",id:t,categoria:n}}function obterCategoria(){for(var n=Math.floor(Math.random()*quantidadeCategorias+1)-1,t=categorias[n],i=1;t.itensRestantes.length===0;){if(i+=1,i>quantidadeCategorias)throw"Não há mais presentes";n+=1;t=categorias[n%quantidadeCategorias]}return t}function obterCategoriaPor(n){switch(n){case"cmb":return categoriaCmb;case"utils":return categoriaUtils;case"eletro":return categoriaEletro;default:return null}}function configurarVisibilidadeBotao(n){var t=!0,r=obterCategoriaPor(n),i;if(r!==null)t=r.itensRestantes.length>0;else for(t=!1,i=0;i<categorias.length;i++)if(categorias[i].itensRestantes.length>0){t=!0;break}t?containerMaisPresentes.show():containerMaisPresentes.hide()}function resetForm(n){n.find("input:text, input:password, input:file, select, textarea").val("");n.find("input:radio, input:checkbox").removeAttr("checked").removeAttr("selected");var t=$("#entry_1004913611");t.hide();t.removeAttr("required")}function shuffle(n){for(var t=n.length,r,i;0!==t;)i=Math.floor(Math.random()*t),t-=1,r=n[t],n[t]=n[i],n[i]=r;return n}function async(n,t){var r=document,u="script",f=r.createElement(u),i=r.getElementsByTagName(u)[0];f.src=n;t&&i.addEventListener("load",function(n){t(null,n)},!1);i.parentNode.appendChild(f,i)}var contagemRegressiva,marcadorCerimonia,marcadorRecepcao,rotaCerimonia,rotaRecepcao,mapaRecepcao,mapaCerimonia,zoomAtivado,mensagens,linhaProgressoMensagens,indexMensagemAtual,totalMensagens;(function(n){var t=n(window),i=t.height();t.resize(function(){i=t.height();alinharLocais(t.width())});n.fn.fixedonlater=function(r){function u(){windowScrollTop=t.scrollTop();e.each(function(){var t=n(this),r=t.outerHeight();windowScrollTop>i-r?(n("#menu-fixo").hide(),t.css("opacity")==="0"&&t.animate({top:"0",opacity:"1"},{queue:!1,duration:f.speedDown})):(n("#menu-fixo").show(),t.animate({top:-r,opacity:"0"},{queue:!1,duration:f.speedUp}))})}var r=n.extend({speedDown:250,speedUp:100},r),f=r,e=n(this);t.bind("scroll",u).resize(u);u()}})(jQuery),function(n){var t=n(window),i=n("iframe[src^='http://player.vimeo.com'], iframe[src^='http://www.youtube.com']");n.fn.responsivevideos=function(){function r(){i.each(function(){var t=n(this);wrapperWidth=t.parent().width()*.7;currentHeight=t.height();currentWidth=t.width();currentAspectRation=currentHeight/currentWidth;t.removeAttr("height").removeAttr("width");t.width(wrapperWidth).height(parseInt(currentAspectRation*wrapperWidth))})}n(document).ajaxComplete(function(){r()});t.bind("resize",r);r()}}(jQuery);$(document).ready(function(){window.onscroll=OnScrollPagina;var n=$(window).width();mostrarVideoInicial(n);$("#contagem").text(contagemRegressiva.frase(new Date));window.onload=function(){configurarConteudoDaTimeLine();definirBackgroundsDasSecoes(n);alinharLocais(n);configurarMapaDaCerimonia();configurarMapaDaRecepcao();cargaInicialDePresentes();configurarSubmissaoDeRsvp();configurarSubmissaoDeMensagem();exibirMensagens();exibirGaleria();$("img.lazy").lazyload({effect:"fadeIn",threshold:300})}});contagemRegressiva={frase:function(n){var i=new Date("November 29, 2014 23:59:59"),t=parseFloat((i-n)/864e5);return t>=2?"Faltam "+parseInt(t)+" dias":t>=1?"Falta "+parseInt(t)+" dia":t>=0&&t<1?"Chegou o dia!":t<0?"Obrigado pela presença!":void 0}};zoomAtivado=!1;mensagens=[{texto:'Posso falar? To completamente apaixonada pelo site! Imagina só como vai ser essa festa!! Com certeza vai ser linda, do jeito que é o amor de vocês! Dá para ver em cada pedacinho desse site! Inha, essa vida nos reserva muitas surpresas, quem imaginou que a gente que estivemos tão próximas um dia nas baladas da vida e agora estamos próximas novamente na contagem regressiva dos nossos casamentos?! Amei cada momento desse nosso grupinho de noivas, e poder participar de tão pertinho da sua festa, como também poder dividir a minha com você! :) Toda felicidade desse mundo para vocês, e esse é realmente só o começo! Bjo grande para o casal "Casadinho" :*',autor:"Raissa Nogueira"},{texto:"Que site lindooo! Tenho certeza que tudo vai sair lindo e delicado como você amiga! Casal querido demais, muito feliz por participar desse casamento tão esperado! Amo vocês!",autor:"Luciana Revoredo"},{texto:"Ficou massa! Site lindo, fotos lindas, igual a vocês!",autor:"Vanessa Rios"},{texto:"Está tudo lindo, só aumentou a expectativa para o grande dia!!! Estou muito contente em fazer parte deste momento junto com vocês. São um casal muito querido!",autor:"Carolina Vieira"},{texto:"Inha & Thiago, Estou realmente muito feliz por vocês e muito emocionada. Minha primeira SOBRINHA que casa. É um sentimento muito gostoso! Que DEUS em sua infinita bondade, abençoe vocês e que nessa união nunca falte: o AMOR, a COMPREENSÃO e o RESPEITO. Sejam muito, muito FELIZES!!!",autor:"Adelita"},{texto:"<p>Que elegância o site!<\/p><p>Que alegria as cores e caras nessas fotos!<\/p><p>O amor está no ar!<\/p><p>Vou respirar bem fundo!<\/p>",autor:"Luce Galvão"},{texto:"Ingrid e Thiago, que coisa mais linda esse site! E o convite também! Fiquei encantada. Dá pra sentir o amor de vocês e que tudo está sendo feito com muito carinho. Parabéns! Desejo do fundo do coração que esse amor e esse cuidado perdure para sempre (até quando você não puder mais usar sapatilha de ponta, amiga bailarina, hehehe!). Grande beijo!",autor:"Larissa Guimarães"},{texto:"Pelo que foi exposto aqui nesta página, vocês estão preparados para uma vida a dois com muitas alegrias e muito amor. Parabéns e que Deus os abençoe e que vocês sejam muito muito felizes",autor:"Paula Meira de Carvalho"},{texto:"Thiago, Você foi uma criança que demonstrava maturidade em suas ideias e firmeza em seus propósitos. Aluno brilhante, enchia-nos de orgulho pelo seu desenvolvimento intelectual. Hoje, um homem com caráter indiscutível, sabe fazer suas escolhas sem medo de errar. Parabéns, Thiaguinho! Desculpe por tratá-lo como se fosse ainda uma criança, mas acho que todos nós temos nosso lado criança. Quero deixar registrado a minha alegria pela sua união com Ingrid, que sem duvida será um casal feliz. Mil beijos!",autor:"Tia Maria"},{texto:"Emocionante a história de vocês, fico triste em não poder compartilhar esse grande dia com vc amiga, mas estarei emanando votos de felicidades de longe, sempre! Beijão",autor:"Rian
os se realizem. Que o amor demonstrado por vocês cresça cada dia mais sendo sempre o elo forte que marcará essa caminhada. Que Deus derrame sobre vocês suas bênçãos, cobrindo-os com o Vosso Sagrado Manto e Nossa Senhora os guie e acompanhe hoje e sempre. São os mais sinceros votos de felicidades para meus queridos sobrinhos.<\/p><p>Mil beijos e forte abraços aos dois.<\/p><p>Obs.: me emocionei bastante com a mensagem de sua tia, Thiago.<\/p>",autor:"Dolores Prado (tia Lolinha)"},{texto:"Minha irmanzinha que tanto AMO, seja muuuuito feliz do lado de mais um Nêgo na sua vida (sei que o mais amado ainda sou eu rsss), te amo sempre e não é pq está saindo da casa do papai que vou parar de te perturbar hehe. Thiago, agora sim COOOOONHADOOOO kkkkkk. Seja muito feliz ao lado da minha maninha, você já faz parte da minha família e agora se lascou, tbm vou te perturbar. Beijos aos dois!!!",autor:"Daniel França Lopes"},{texto:'<p>Um lindo casal!!! Thiago, de sua tia mais "distante", quase oculta, porém nem por isso menos desejosa de sua felicidade. A Meirinha me era muito querida e vocês  (André, Thiago e Lucas) são o forte elo que me traz sempre presente, a figura íntegra de sua mãe. Neste momento, estou por demais emocionada com a sua história, como HOMEM lindo que é, por dentro e por fora. Desejo ao casal Thiago e Ingrid, nesta oportunidade, uma união de Paz e Amor; através da cumplicidade entre vocês, respeito mútuo e leveza daquela liberdade ética e sincera que, com certeza, os farão sempre muito felizes.<\/p><p>Com afeto<\/p><p>Ângela<\/p>',autor:"Ângela Antônia Teixeira Sales"},{texto:"<p>Sei que a chuva que caiu na manhã do dia 29.11.2014 em Fortaleza, foram bênçãos que Deus enviou do céu para vocês que naquele dia iniciavam um nova e importante etapa em suas vidas. Inha, quase vinte e sete anos se passaram mas ainda lembro a emoção que senti ao vê-la pela primeira vez, que foi ainda na maternidade. Naquele momento tive a confirmação de que no meu coração cabia mais amor do que poderia supor. Foram muitas situações de você bebê, aprendendo a andar, falar, indo para a escola, adolescência e principalmente os dois meses que você ficou lá em casa, que voltaram na minha memória no momento em que a vi de noiva. Não deu para segurar! as lágrimas vieram viu!? Hoje esse amor é repartido com você e a pessoa que escolheu para dividir sua vida, pois o Thiago já ocupa um espaço no coração de todo Prado Carvalho. Espero que essa união seja consolidada com muito amor, compreensão e paz. Sei também que seus avós estão muito felizes no céu. BEIJÃO.<\/p><p>De sua madrinha (pequena mãe) tia Dinda.<\/p>",autor:"Liduina Prado (tia Dinda)"}];var categoriaAtual=null,categoriaCmb={nome:"cmb",quantidade:8},categoriaEletro={nome:"eletro",quantidade:9},categoriaUtils={nome:"utils",quantidade:10},categorias=[categoriaCmb,categoriaEletro,categoriaUtils],quantidadeCategorias=categorias.length,spinner=$("#spinner-presentes"),containerMaisPresentes=$("#mais-presentes"),quantidadeTotal=0;jQuery.fn.shuffle=function(){for(var t,n=0;n<this.length;n++)t=Math.floor(Math.random()*this.length),$(this[n]).before($(this[t]));return this},function(n,t){typeof exports=="object"?module.exports=t():typeof define=="function"&&define.amd&&define("GMaps",[],t);n.GMaps=t()}(this,function(){
/*!
 * GMaps.js v0.4.14
